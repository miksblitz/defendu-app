...
export class MessageController {
  ...
  static async getConversations(currentUserId: string): Promise<ConversationSummary[]> {
  ...
  /** Subscribe to userChats for real-time unread count. Callback receives raw userChats snapshot. */
  static subscribeUserChats(
    currentUserId: string,
  ...
  static subscribeMessages(chatId: string, callback: (messages: ChatMessage[]) => void): () => void {
    const messagesRef = ref(db, `chats/${chatId}/messages`);
